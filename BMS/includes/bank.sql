...
`accifsc` varchar(25) NOT NULL,
`accemail` varchar(25) NOT NULL,
...
INSERT INTO `transactions` (`transactionid`, `paymentdate`, `payeeid`, `receiveid`, `amount`) VALUES
(1, '2013-07-03 12:16:15', 4666, 67543, 1),
(2, '2013-07-03 05:40:33', 98683, 67543, 2),
(3, '2013-07-03 07:45:13', 98683, 67543, 10);
