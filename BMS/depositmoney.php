...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
			...
			if($temp){
				...
				if($amount>0){
               	...
               	$run5 = mysqli_query($con, $ins_sql);
								...
								$sql5 = "INSERT INTO transactions(transactionid, paymentdate, payeeid,receiveid,amount) VALUES('".$cnt2."', '".$date."','".$one."', '".$accno."','".$amount."')";
        	...
        	$success = "successful deposit!";
					...
					$success = "Amount cant be negative!";
				}
			}else{
