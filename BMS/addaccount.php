...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
		...
		$accdate = date('y-m-d');
		$ins_sql = "INSERT INTO accounts(accname, accno, accifsc, accemail, accpassword, acctype, accbalance, accdate) VALUES ('".$accname."', '".$accno."', '".$accifsc."', '".$accemail."', '".($accpassword)."', '".$acctype."', '".$accbalance."', '".$accdate."')";
...
<div class="row">
    ...
    <div class="page-header">
			...
			<form class="form-horizontal" action="addaccount.php" method="post" role="form">
				...
				<div class="form-group">
					<label for="number" class="col-sm-3 control-label">A/c number</label>
						<div class="col-sm-8">
				...
				<div class="form-group">
					<label for="number" class="col-sm-3 control-label">A/c balance</label>
						<div class="col-sm-8">
